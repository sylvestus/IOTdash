...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('user_management', ['users' => $records, 'notifications' => $notifications, 'user_type' => $user_type, 'user_addedby' => $user_addedby, 'userId' => $userId]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('user_management')->with('failure', 'user failed to Add:  ' . $e->getMessage());
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('user_details', ['user' => $user, 'notifications' => $notifications, 'user_type' => $user_type, 'userId' => $userId]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('user_management')->with('failure', 'user failed to update' . $e->getMessage());
        }
    }
