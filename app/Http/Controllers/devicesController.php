...
class devicesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('device_management', compact('devices', 'notifications', 'users', 'our_sites', 'user_type', 'user_addedby'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $message = 'Failed to insert device' . $e->getMessage();
            $success = false;
            ...
            return redirect()->back()->with('failure', 'failed to add device' . $e->getMessage());
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('devices', compact('device', 'records', 'user_type'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('device_management')->with('failure', 'Device failed to update' . $e->getMessage());
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if ($device) {
            ...
            return redirect()->route('device_management')->with('success', 'Device deleted successfully');
        } else {
