...
class SaveDistanceController extends Controller
{
        ...
        foreach ($packegeExpiryWarning as $packegeExpiryWarning) {
            ...
            if ($paymentdate->isBetween($paymentdate, $fiveDaysAhead, true)) {
                ...
                try {
                    ...
                    return redirect()->back()->with('failure', 'failed failed to notify user of expured  subscriptions' . $e->getMessage());
                }
            }
            ...
            try {
                ...
                return redirect("home")->with('failure', 'failed failed to update expired  subscriptions' . $e->getMessage());
            }
            }
        }
    }
    ...
    public function index()
    {
        ...
        return view('index', ['records' => $records, 'users' => $users, 'devices' => $devices, 'subscriptions' => $subscriptions, 'notifications' => $notifications]);
    }
