...
class MySubscriptionContoller extends Controller
{
    ...
    public function index()
    {
        ...
        // dd($packagesSubed);
        return view('mysubscriptions', ['mysubscriptions' => $subscriptionIds, 'receiptedSubscriptions' => $packagesSubed]);
    }
    ...
    public function save_reciept(Request $request)
    {
        ...
        try {
            ...
            return redirect()->back()->with('failure', 'subscription reciept failed to generate' . $e->getMessage())->with('reload', true);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect('mysubscriptions')->with('success', 'your subscription status has been updated  successfully');
        } catch (\Exception $e) {
            return redirect('mysubscriptions')->with('failure', 'failed to update subscription' . $e->getMessage());
        }
    }
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return redirect()->route('mysubscriptions')->with('success', 'subscription deleted successfully');
        } catch (\Exception $e) {
            return redirect()->route('mysubscriptions')->with('failure', 'Failed to delete' . $e->getMessage());
        }
    }
}
